...
bool string_substring_deep(string_t * outstring, const string_t * src, size_t start, size_t length);
bool string_getAt(string_t * s, size_t index, char * outch);
bool string_overWrite(string_t * dst, const string_t *  src, size_t start);
...
bool stringBuilder_new(stringBuilder_t * outsb);
bool stringBuilder_append(stringBuilder_t * outsb, char * str, int length);
bool stringBuilder_toString(string_t * outstr, stringBuilder_t * insb);
